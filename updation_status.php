  ...
  <fieldset>
      <div class="row">
        <div class="col-md-12 text-center">
          <div>
            <strong><h3>Updation Status</h3></strong>
          </div>
        </div>
      </div><br><br>
                <div class="row">
                  <div class="col-xs-12 col-sm-10">
                    <form class="form-horizontal" role="form" method="POST" action="updation_show.php">
                    <div class="form-group">
                        <label for="Bhamashah" class="col-sm-4 col-md-offset-3 control-label">Bhamashah / Token Number</label>                       
                        <div class="col-sm-4">
                        <input type="text" class="form-control" id="id" name="id" placeholder="Enter Bhamashah ID">
                        </div>
                    </div>
